...
export declare class PropertyGraph extends Graph<Property> {
    ...
    linkTexture(name: string, channels: number, a: Material | ExtensionProperty, b: null): null;
    linkTexture(name: string, channels: number, a: Material | ExtensionProperty, b: Texture): TextureLink;
    linkTexture(name: string, channels: number, a: Material | ExtensionProperty, b: Texture | null): TextureLink | null;
}
