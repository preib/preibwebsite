...
const SearchBox = ({ initialValue, onSearch, placeholder }: SProps) => {
    ...
    return (
        <form onSubmit={ (ev) => {
            ...
            <div className="w-full flex h-14 gap-0 border-2 rounded-xl focus-within:shadow transition-shadow focus-within:ring">
                <input
                    ref={searchInput}
                    type="text"
                ...
                />
                <button type="submit">
                    <div className="cursor-pointer mr-3 text-gray-800 hover:text-gray-500 transition-colors">
