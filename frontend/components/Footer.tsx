					...
					<div className="col-span-2">
						...
						<div className="flex flex-row gap-x-4 items-center">
							<Link href="https://www.instagram.com/pre_ib/">
								<a>
									<svg className="w-12 h-12 transform hover:scale-110 transition-transform" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" viewBox="0 0 512 512">
										<g>
							...
							<Link href="https://www.linkedin.com/company/pre-ib/about/">
								<a>
									<svg className="w-10 h-10 transform hover:scale-110 transition-transform" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
