...
export function Spinner({ color="white" }: IProps) {
    return (
        <svg className={`animate-spin -ml-1 mr-3 h-5 w-5 text-${color}`}
...
export default function LoadingDiv({ message, borderColor = "border-blue-700", backgroundColor = "bg-blue-600", spinnerColor="white" }) {
    return (
